    ...
    return (
      ...
      >
        ...
        <h3 style={{ paddingTop: "50px" }}>
          The MIT database can be located here:
        ...
        >
          Upload the 4 files for each patient. Specifically the files with the
          extensions .atr, .hea, .xws, .dat. For example, if you want to insert
          patient 100, upload the following 4 files: 100.atr 100.hea 100.xws
          100.dat
        </h4>
        <div style={{ paddingTop: "100px", paddingBottom: "150px" }}>
          ...
          <button
            style={{ width: "25%", margin: "0 auto", align: "center" }}
